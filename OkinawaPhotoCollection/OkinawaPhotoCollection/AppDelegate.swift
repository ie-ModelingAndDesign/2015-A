...
//
//  Created by 宮里　悠太郎 on 2015/11/06.
...
//    }
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "ie2015-A.OkinawaPhotoCollection" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("OkinawaPhotoCollection", withExtension: "momd")!
